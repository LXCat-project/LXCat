    ...
    return (
        <Layout>
            ...
            <form>
                ...
                {id && id === section._key && <span>Update successful, a draft has been created with id is {id}</span>}
                {id && id !== section._key && <span>Update successful, the draft been updated.</span>}
            </form>
        </Layout>
    )
}
