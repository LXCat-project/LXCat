...
export const ParticleIndbAsJsonSchema = generateJsonSchemaFromType(collectionsPath, 'Particle')

export const ContributorIndbAsJsonSchema = generateJsonSchemaFromType(collectionsPath, 'Contributor')

export const ReferenceIndbAsJsonSchema = generateJsonSchemaFromType(collectionsPath, 'Reference')
...
export const ReactionIndbAsJsonSchema = generateJsonSchemaFromType(collectionsPath, 'Reaction')
