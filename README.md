...
```
cd existing_repo
git remote add origin https://gitlab.com/LXCat-project/lxcat-ng.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/LXCat-project/lxcat-ng/-/settings/integrations)
