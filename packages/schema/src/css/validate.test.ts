    ...
    const expected = [
      {
        ...
        "message": "term inconsistent: with L1=1, S1=0.5, J1 should be one of 1.5,0.5"
      },
      {
        "keyword": "J1L2 coupling",
        ...
        "message": "term inconsistent: with K=1.5, S2=0.5, J should be one of 2,1"
      },
      {
        "keyword": "J1L2 coupling",
        "instancePath": "third/electronic/1",
        ...
        "message": "term inconsistent: with J1=1.5, L2=2, K should be one of 3.5,2.5,1.5,0.5"
      },
      {
        "keyword": "LS coupling",
        ...
        "message": "term incosistent with config: for [{n:3,l:2,occupance:1}], parity should be 1"
      },
      {
        ...
        "message": "term inconsistent with config: for [{n:3,l:2,occupance:1}], L should be one of 2, and S=0.5"
      }
    ];
    expect(validator.errors).toEqual(expected);
  });
